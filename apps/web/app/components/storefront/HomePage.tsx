...
const marketCopy: Record<Locale, {
  ...
  ru: {
    ...
    topSections: "Разделы каталога",
    topSectionsText: "Литература для разных интересов и настроений. Выберите направление и найдите следующую книгу.",
    topPublishers: "Издательства",
    topPublishersText: "Откройте книги любимых издательств и познакомьтесь с новыми именами.",
    ...
    otherText: "Исследуйте новые темы и откройте для себя неожиданные истории.",
    offers: "Специальные предложения",
    offersText: "Книги по доступным ценам для вашей полки и в подарок.",
    recommended: "Рекомендуем",
    recommendedText: "Несколько идей для тех, кто ищет, что почитать дальше.",
    ...
    questions: [
      ["Как узнать наличие и итоговую стоимость?", "Наличие подтверждаем при обработке заказа. Перед доставкой согласуем с вами состав заказа и итоговую сумму."],
      ["Как подтверждается заказ?", "После оформления мы свяжемся с вами, уточним наличие книг и детали доставки."],
      ["Куда вы доставляете?", "Доставляем по Еревану за 1 000 ֏. Время доставки согласуем с вами при подтверждении заказа."],
    ],
  ...
  hy: {
    ...
    topSections: "Կատալոգի բաժիններ",
    topSectionsText: "Գրքեր տարբեր հետաքրքրությունների և տրամադրությունների համար։ Ընտրեք թեման և գտեք ձեր հաջորդ գիրքը։",
    topPublishers: "Հրատարակիչներ",
    topPublishersText: "Բացահայտեք սիրելի հրատարակիչների գրքերը և ծանոթացեք նոր անունների։",
    ...
    other: "Այլ բաժիններ",
    otherText: "Ուսումնասիրեք նոր թեմաներ և բացահայտեք անսպասելի պատմություններ։",
    offers: "Հատուկ առաջարկներ",
    offersText: "Գրքեր մատչելի գներով՝ ձեր գրադարանը համալրելու կամ նվիրելու համար։",
    recommended: "Խորհուրդ ենք տալիս",
    recommendedText: "Մի քանի գաղափար նրանց համար, ովքեր ընտրում են իրենց հաջորդ գիրքը։",
    ...
    questions: [
      ["Ինչպե՞ս ճշտել առկայությունն ու վերջնական արժեքը", "Առկայությունը հաստատում ենք պատվերը մշակելիս։ Մինչև առաքումը ձեզ հետ համաձայնեցնում ենք պատվերի կազմն ու վերջնական գումարը։"],
      ["Ինչպե՞ս է հաստատվում պատվերը", "Պատվերը ձևակերպելուց հետո կկապվենք ձեզ հետ՝ ճշտելու գրքերի առկայությունն ու առաքման մանրամասները։"],
      ["Որտե՞ղ եք առաքում", "Առաքում ենք Երևանում՝ 1 000 ֏ արժեքով։ Առաքման ժամը համաձայնեցնում ենք պատվերը հաստատելիս։"],
    ],
  ...
  en: {
    ...
    topSections: "Browse by category",
    topSectionsText: "Books for different interests and moods. Pick a category and find your next read.",
    topPublishers: "Publishers",
    topPublishersText: "Explore books from your favorite publishers and discover new names.",
    ...
    otherText: "Explore new subjects and discover stories you might not expect.",
    offers: "Special offers",
    offersText: "Affordable books for your own shelf or a thoughtful gift.",
    recommended: "Recommended",
    recommendedText: "A few ideas for anyone choosing what to read next.",
    ...
    questions: [
      ["How do I check availability and the final price?", "We confirm availability while processing your order. Before delivery, we agree the order details and final total with you."],
      ["How is an order confirmed?", "After you place your order, we contact you to confirm the books and delivery details."],
      ["Where do you deliver?", "We deliver across Yerevan for 1,000 ֏. We agree the delivery time with you when confirming your order."],
    ],
