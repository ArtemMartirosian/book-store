...
export const dictionary = {
  ru: {
    ...
    footer: {
      about: "LUMI Books — книжный интернет-магазин. Книги на армянском, русском и английском с доставкой по Еревану.",
    ...
    home: {
      ...
      aboutOverline: "Почему LUMI", aboutTitle: "Книжный магазин без лишней суеты", aboutText: "LUMI Books — книжный интернет-магазин для любителей хороших историй. Выбирайте книги, оформляйте заказ и оплачивайте его при получении. Стоимость доставки видна в корзине.",
    },
    ...
    account: {
      overline: "Личное пространство", title: "Ваши книги.", accent: "Ваш ритм.", intro: "Выбирайте книги, сохраняйте понравившееся и оформляйте заказы без регистрации.", quote: "Чтение создаёт тихое пространство, в котором мы снова слышим себя.", team: "Команда LUMI",
  ...
  hy: {
    ...
    footer: {
      about: "LUMI Books-ը առցանց գրախանութ է։ Հայերեն, ռուսերեն և անգլերեն գրքեր՝ առաքմամբ Երևանում։",
    ...
    home: {
      ...
      aboutOverline: "Ինչու LUMI", aboutTitle: "Գրախանութ՝ առանց ավելորդ հոգսերի", aboutText: "LUMI Books-ը առցանց գրախանութ է լավ պատմությունների սիրահարների համար։ Ընտրեք գրքերը, ձևակերպեք պատվերը և վճարեք ստանալիս։ Առաքման արժեքը նշված է զամբյուղում։",
    },
    ...
    cart: {
      ...
      payment: "Վճարում", onDelivery: "Կանխիկ՝ ստանալիս", onDeliveryHint: "Վճարեք առաքիչին պատվերը ստանալիս", selected: "Կանխիկ", total: "Ընդամենը", yourOrder: "Ձեր պատվերը", delivery: "Առաքում Երևանում", serverAdjustment: "Գնի թարմացում", toPay: "Ընդհանուր գումար", submit: "Ձևակերպել պատվերը", submitting: "Ուղարկվում է…", submitError: "Չհաջողվեց ուղարկել պատվերը։ Ստուգեք հեռախոսահամարն ու ինտերնետ կապը և փորձեք կրկին։", quoteChanged: "Գինը փոխվել է։ Ստուգեք նոր գումարը և կրկին սեղմեք «Ձևակերպել պատվերը»։ Նոր գումարը՝", successTotal: "Պատվերի գումարը", submitHint: "Առկայությունն ու առաքման մանրամասները կհաստատենք հեռախոսով։", legal: "Սեղմելով՝ ընդունում եք վաճառքի պայմանները և հաստատում գաղտնիության ծանուցմանը ծանոթանալը։ Գովազդային համաձայնությունները տրվում են առանձին։",
    ...
    account: {
      overline: "Անձնական տարածք", title: "Ձեր գրքերը։", accent: "Ձեր ռիթմը։", intro: "Ընտրեք գրքերը, պահպանեք հավանածները և պատվիրեք առանց գրանցման։", quote: "Ընթերցանությունը ստեղծում է լուռ տարածք, որտեղ նորից լսում ենք մեզ։", team: "LUMI թիմ",
  ...
  en: {
    ...
    footer: {
      about: "LUMI Books is your online bookstore. Armenian, Russian and English books, delivered across Yerevan.",
    ...
    home: {
      ...
      aboutOverline: "Why LUMI", aboutTitle: "A bookstore without the busywork", aboutText: "LUMI Books is an online bookstore for people who love a good story. Choose your books, place an order and pay when it arrives. The delivery fee is shown in your cart.",
    },
    ...
    account: {
      overline: "Your space", title: "Your books.", accent: "Your rhythm.", intro: "Explore books, save your favorites and place orders without signing up.", quote: "Reading creates a quiet space where we can hear ourselves again.", team: "LUMI team",
