...
export const dictionary = {
  ru: {
    header: {
      ...
      search: "Название, автор или ISBN", searchButton: "Найти", account: "Кабинет", cart: "Корзина",
      announcement: "Доставка по Еревану — 1 000 ֏ · Оплата при получении", menu: "Открыть меню",
      allCategories: "Все разделы", bestsellers: "Бестселлеры", english: "На английском", classics: "Классика", selfDevelopment: "Саморазвитие", howOrder: "Как заказать", city: "Ереван", cash: "Наличными курьеру",
    },
    footer: {
      about: "Книжный сервис для тех, кто выбирает осмысленно. Доставляем по Еревану.",
      buyers: "Покупателям", catalog: "Каталог", delivery: "Доставка и оплата", orders: "Мои заказы",
    ...
    home: {
      ...
      values: [["3 языка", "Հայերեն · Русский · English"], ["Честное наличие", "Подтверждаем перед заказом"], ["По всему Еревану", "Удобный интервал доставки"], ["Оплата при получении", "Спокойно и прозрачно"]],
      ...
      choose: "Выбрать книгу", deliveryOverline: "04 / Доставка", deliveryTitle: "От заявки\nдо вашей полки", deliveryText: "Простой и прозрачный путь заказа — без предоплаты на старте.",
      steps: [["Вы выбираете", "Соберите корзину и укажите адрес в Ереване."], ["Мы подтверждаем", "Проверим наличие и позвоним с итоговой суммой."], ["Получаете", "Курьер привезёт заказ, вы оплатите при получении."]],
      ...
      deliveryCardTitle: "Доставка по Еревану", deliveryCardText: "После подтверждения наличия", cashCardTitle: "Оплата наличными", cashCardText: "Курьеру при получении", pickTitle: "Выбор недели", viewBook: "Посмотреть книгу",
    ...
    product: {
      ...
      flow: [["Заявка", "Вы оформляете заказ без предоплаты."], ["Проверка", "Мы подтверждаем точное наличие и цену."], ["Доставка", "Вы получаете и оплачиваете заказ."]], related: "Вам может понравиться", continue: "Продолжить выбор", all: "Весь каталог",
    },
    cart: {
      ...
      payment: "Оплата", onDelivery: "При получении", onDeliveryHint: "Оплатите заказ курьеру после получения", selected: "Выбрано", total: "Итого", yourOrder: "Ваш заказ", delivery: "Доставка по Еревану", serverAdjustment: "Обновление цены", toPay: "К оплате", submit: "Оформить заявку", submitting: "Отправляем…", submitError: "Не удалось отправить заявку. Проверьте телефон и подключение к API, затем попробуйте снова.", quoteChanged: "Цена изменилась. Проверьте новую сумму и нажмите «Оформить заявку» ещё раз. Новая сумма:", successTotal: "Сумма заявки", submitHint: "Оплата только после подтверждения наличия оператором.", legal: "Нажимая кнопку, вы принимаете условия продажи и подтверждаете ознакомление с уведомлением о конфиденциальности. Рекламные согласия оформляются отдельно.",
  ...
  hy: {
    header: {
      ...
      search: "Գիրք, հեղինակ կամ ISBN", searchButton: "Փնտրել", account: "Իմ էջը", cart: "Զամբյուղ",
      announcement: "Առաքում Երևանում՝ 1 000 ֏ · Վճարում ստանալիս", menu: "Բացել ընտրացանկը",
      allCategories: "Բոլոր բաժինները", bestsellers: "Բեսթսելերներ", english: "Անգլերեն", classics: "Դասականներ", selfDevelopment: "Ինքնազարգացում", howOrder: "Ինչպես պատվիրել", city: "Երևան", cash: "Կանխիկ՝ առաքիչին",
    },
    footer: {
      about: "Գրքային ծառայություն մտածված ընտրության համար։ Առաքում ենք Երևանում։",
      buyers: "Գնորդներին", catalog: "Գրացուցակ", delivery: "Առաքում և վճարում", orders: "Իմ պատվերները",
    ...
    home: {
      ...
      values: [["3 լեզու", "Հայերեն · Русский · English"], ["Իրական առկայություն", "Հաստատում ենք պատվերից առաջ"], ["Ամբողջ Երևանով", "Հարմար առաքման ժամ"], ["Վճարում ստանալիս", "Հանգիստ և թափանցիկ"]],
      ...
      choose: "Ընտրել գիրք", deliveryOverline: "04 / Առաքում", deliveryTitle: "Հայտից\nմինչև ձեր դարակ", deliveryText: "Պարզ և թափանցիկ պատվեր՝ սկզբում առանց կանխավճարի։",
      steps: [["Դուք ընտրում եք", "Հավաքեք զամբյուղը և նշեք Երևանի հասցեն։"], ["Մենք հաստատում ենք", "Կճշտենք առկայությունն ու կզանգենք վերջնական գումարով։"], ["Դուք ստանում եք", "Առաքիչը կբերի պատվերը, կվճարեք ստանալիս։"]],
      ...
      deliveryCardTitle: "Առաքում Երևանում", deliveryCardText: "Առկայությունը հաստատելուց հետո", cashCardTitle: "Կանխիկ վճարում", cashCardText: "Առաքիչին՝ ստանալիս", pickTitle: "Շաբաթվա ընտրանին", viewBook: "Դիտել գիրքը",
    ...
    product: {
      ...
      flow: [["Հայտ", "Պատվերը ձևակերպում եք առանց կանխավճարի։"], ["Ստուգում", "Մենք հաստատում ենք ճշգրիտ առկայությունն ու գինը։"], ["Առաքում", "Դուք ստանում և վճարում եք պատվերը։"]], related: "Ձեզ կարող է դուր գալ", continue: "Շարունակել ընտրությունը", all: "Ամբողջ գրացուցակը",
    },
    cart: {
      ...
      payment: "Վճարում", onDelivery: "Ստանալիս", onDeliveryHint: "Վճարեք առաքիչին պատվերը ստանալուց հետո", selected: "Ընտրված է", total: "Ընդամենը", yourOrder: "Ձեր պատվերը", delivery: "Առաքում Երևանում", serverAdjustment: "Գնի թարմացում", toPay: "Վճարման ենթակա", submit: "Ուղարկել հայտը", submitting: "Ուղարկվում է…", submitError: "Չհաջողվեց ուղարկել հայտը։ Ստուգեք հեռախոսահամարը և API կապը, ապա փորձեք կրկին։", quoteChanged: "Գինը փոխվել է։ Ստուգեք նոր գումարը և կրկին սեղմեք «Ուղարկել հայտը»։ Նոր գումարը՝", successTotal: "Հայտի գումարը", submitHint: "Վճարում եք միայն օպերատորի կողմից առկայությունը հաստատելուց հետո։", legal: "Սեղմելով՝ ընդունում եք վաճառքի պայմանները և հաստատում գաղտնիության ծանուցմանը ծանոթանալը։ Գովազդային համաձայնությունները տրվում են առանձին։",
  ...
  en: {
    header: {
      ...
      search: "Title, author or ISBN", searchButton: "Search", account: "Account", cart: "Cart",
      announcement: "Yerevan delivery — 1,000 ֏ · Pay on delivery", menu: "Open menu",
      allCategories: "All categories", bestsellers: "Bestsellers", english: "English books", classics: "Classics", selfDevelopment: "Self-development", howOrder: "How to order", city: "Yerevan", cash: "Cash to the courier",
    },
    footer: {
      about: "A book service for considered choices. Delivered across Yerevan.",
      buyers: "For readers", catalog: "Catalog", delivery: "Delivery & payment", orders: "My orders",
    ...
    home: {
      ...
      values: [["3 languages", "Հայերեն · Русский · English"], ["Honest availability", "Confirmed before ordering"], ["Across Yerevan", "A convenient delivery window"], ["Pay on delivery", "Simple and transparent"]],
      ...
      choose: "Choose a book", deliveryOverline: "04 / Delivery", deliveryTitle: "From request\nto your shelf", deliveryText: "A simple, transparent journey — no upfront payment during launch.",
      steps: [["You choose", "Build your cart and add a Yerevan address."], ["We confirm", "We check availability and call with the final total."], ["You receive", "The courier delivers; you pay on receipt."]],
      ...
      deliveryCardTitle: "Yerevan delivery", deliveryCardText: "After availability is confirmed", cashCardTitle: "Cash payment", cashCardText: "To the courier on delivery", pickTitle: "Pick of the week", viewBook: "View book",
    ...
    product: {
      home: "Home", catalog: "Catalog", choice: "LUMI selection", about: "About the book", reviews: "reviews", fallback: "The supplier description appears in Russian when a localized version is not ready yet.", servicePrice: "Price includes the LUMI service", unavailable: "Unavailable now", unavailableHint: "Save the book and we’ll tell you when that changes.", checkStock: "We confirm availability before ordering", lastCheck: "Last checked", add: "Add to cart", unavailableButton: "Unavailable", favorite: "Add to favorites", removeFavorite: "Remove from favorites", delivery: "Delivery 1,000 ֏", deliveryHint: "Across Yerevan, after confirmation", pay: "Pay on delivery", payHint: "Only after we verify the order",
      ...
      flow: [["Request", "Place the order with no upfront payment."], ["Verification", "We confirm exact availability and price."], ["Delivery", "Receive and pay for your order."]], related: "You may also like", continue: "Keep exploring", all: "Full catalog",
    },
    cart: {
      ...
      payment: "Payment", onDelivery: "On delivery", onDeliveryHint: "Pay the courier after receiving the order", selected: "Selected", total: "Summary", yourOrder: "Your order", delivery: "Yerevan delivery", serverAdjustment: "Price update", toPay: "Total due", submit: "Place request", submitting: "Sending…", submitError: "We could not send the request. Check the phone number and API connection, then try again.", quoteChanged: "The price changed. Review the new total and press “Place request” again. New total:", successTotal: "Request total", submitHint: "You pay only after our operator confirms availability.", legal: "By clicking, you accept the terms of sale and confirm that you have read the privacy notice. Marketing consent is handled separately.",
