...
const copy: Record<Locale, {
  ...
  ru: {
    ...
    accent: "своё издание.",
    intro: "Расширенный поиск по данным, которые сохранены из карточек Books.am. Можно заполнить одно или несколько полей.",
    search: "Найти книги",
    searching: "Ищем…",
    reset: "Очистить",
    ...
    error: "Не удалось выполнить поиск. Проверьте соединение с API.",
  ...
  hy: {
    ...
    intro: "Ընդլայնված որոնում Books.am-ի ապրանքային էջերից պահպանված տվյալներով։ Կարելի է լրացնել մեկ կամ մի քանի դաշտ։",
    search: "Գտնել գրքերը",
    ...
    error: "Որոնումը չհաջողվեց։ Ստուգեք API կապը։",
  ...
  en: {
    ...
    accent: "edition.",
    intro: "Advanced search across the product details stored from Books.am. Fill in one field or combine several.",
    search: "Find books",
    searching: "Searching…",
    reset: "Clear",
    ...
    error: "Search could not be completed. Check the API connection.",
